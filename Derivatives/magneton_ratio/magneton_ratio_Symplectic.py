...
Primary Formula (Symplectic):
  mu_B/mu_N = m_p/m_e = 1836.15

Symplectic interpretation: mu_B/mu_N from phase space structure of vacuum oscillators.
============================================================
"""
