...
Primary Formula (Implicit):
  mu_B/mu_N = m_p/m_e = 1836.15

Implicit framework: mu_B/mu_N from constraint equations on vacuum parameters.
============================================================
"""
