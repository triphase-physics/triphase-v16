...
Primary Formula (StatMech):
  mu_B/mu_N = m_p/m_e = 1836.15

Statistical mechanics: mu_B/mu_N from microstate counting of vacuum configurations.
============================================================
"""
