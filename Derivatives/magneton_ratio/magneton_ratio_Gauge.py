...
Primary Formula (Gauge):
  mu_B/mu_N = m_p/m_e = 1836.15

Gauge theory: mu_B/mu_N from gauge invariance of the vacuum field.
============================================================
"""
