...
============================================================
The Anchor_Condensed framework uses compact notation:
- Same derivation chain as Anchor_Primitive
- Uses standard symbols (alpha, c, Z_0, hbar) for readability
- All symbols are DEFINED from epsilon_0 and mu_0 at the top
- More concise but equally rigorous
...
Primary Formula (Anchor_Condensed):
  R_inf = alpha^2 * m_e * c / (2*h)
...
if __name__ == "__main__":
    ...
    print("\n" + "-" * 70)
    print("DERIVATION: Anchor_Condensed")
    print("-" * 70)
    print()
