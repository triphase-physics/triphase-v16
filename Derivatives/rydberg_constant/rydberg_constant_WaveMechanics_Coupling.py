...
============================================================
Wave Mechanics Coupling focuses on HOW waves interact:
- Coupling constants as impedance matching
- Z_0 sets the coupling scale
- Mode structure determines coupling nodes
- Self-interaction corrections from field coupling
...
Primary Formula (WaveMechanics_Coupling):
  R_inf = alpha^2 / (2 * lambda_C) where lambda_C = Compton wavelength
...
if __name__ == "__main__":
    ...
    print("\n" + "-" * 70)
    print("DERIVATION: WaveMechanics_Coupling")
    print("-" * 70)
    print()
    print("  Formula: R_inf = alpha^2 / (2 * lambda_C) where lambda_C = Compton wavelength")
    print()
