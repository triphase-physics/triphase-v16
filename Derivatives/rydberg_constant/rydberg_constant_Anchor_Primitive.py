...
- NO shortcut symbols like alpha, G, H_0 etc.
...
Primary Formula (Anchor_Primitive):
  R_inf = alpha^2 / (4*pi*a_0_Bohr) where alpha from eps0/mu0 chain
...
if __name__ == "__main__":
    ...
    print("\n" + "-" * 70)
    print("DERIVATION: Anchor_Primitive")
    print("-" * 70)
    print()
    print("  Formula: R_inf = alpha^2 / (4*pi*a_0_Bohr) where alpha from eps0/mu0 chain")
    print()
